...
// Returns empty logs (instead of error) when the response list is shorter than expected,
// which can happen with precompiled contract calls whose responses use a different proto type.
