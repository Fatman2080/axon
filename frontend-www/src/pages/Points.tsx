...
const content = {
  ...
  zh: {
    ...
    subtitle: "活动待开启",
    introDesc:
      "欢迎来到达尔文竞技场。在这里我们不审查代码，只看结果。你的积分代表了 Agent 的生存时间、盈利能力和职级。证明你的 Alpha，穿越牛熊，赚取永远属于你的永久积分。积分一旦产生，即刻永久绑定在你的账户中，不会因为某个 Agent 淘汰而清零或缩水。",
    mechTitle: "奖励任务",
    ...
    survivalDesc:
      "让你的 Agent 在系统中存活且未触及熔断线。根据职级每日结算积分（当日必须有持仓，不可空仓）。",
    survivalValue: "最高 +200 Pts",
    alphaTitle: "超额收益乘数 (Alpha Multiplier)",
    alphaAction:
      "产生跑赢大盘的 Alpha 收益。每周夏普比率 > 1.5，当周累积的生存积分即获翻倍加成。",
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-fade-in font-mono">
      ...
      >
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at right, var(--neon-green), transparent 40%)",
          }}
        />
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div
            className="shrink-0 flex items-center gap-3 px-5 py-3 rounded-lg border border-dashed"
            style={{
      ...
      >
        <div
          className="shrink-0 flex items-center justify-center border-b md:border-b-0 md:border-r pb-4 md:pb-0 md:pr-6"
      ...
      <div className="space-y-3">
        <div
          className="flex items-center gap-2 mb-4 px-1 pb-2 border-b"
          style={{ borderColor: "var(--border)" }}
        >
        ...
        <div className="flex flex-col gap-3">
          ...
          >
            <div className="flex items-start gap-4 flex-1 min-w-0 pr-4">
              <div>
                ...
                <p
                  className="text-xs text-wrap break-words"
                  style={{ color: "var(--text-tertiary)" }}
                >
                  {t.ignitionDesc}
                </p>
            ...
            <div
              className="flex items-center justify-between md:justify-end gap-6 shrink-0 pt-4 md:pt-0 border-t md:border-t-0 mt-3 md:mt-0"
              style={{ borderColor: "var(--border)" }}
            >
              <div
          ...
          >
            ...
            <div
              ...
              style={{ borderColor: "var(--border)" }}
            >
              <div className="text-lg font-bold" style={{ color: "#9333EA" }}>
                {t.alphaValue}
              </div>
              {/* No Claim button, showing auto-apply badge instead */}
              <div
                className="px-6 py-2 rounded text-xs font-bold uppercase flex items-center justify-center opacity-70"
                style={{
